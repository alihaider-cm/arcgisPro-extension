...
public class PlanAdvertisementAreaWizardButton : Button
{
    private PlanAdvertisementAreaWizard _window;
    ...
    protected override void OnClick()
    {
        if (_window is null)
        {
            ...
            _window = App.Container.Resolve<PlanAdvertisementAreaWizard>();
